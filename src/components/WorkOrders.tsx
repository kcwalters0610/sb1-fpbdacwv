...
export default function WorkOrders() {
  ...
  const deleteWorkOrder = async (id: string) => {
    ...
    try {
      ...
      // If the deleted work order was selected, clear the selection
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            <div className="p-4 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900">Work Orders ({filteredWorkOrders.length})</h3>
            </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center mt-3 space-x-4">
                      <select
                        ...
                        onChange={(e) => updateStatus(selectedWorkOrder.id, e.target.value)}
                        className={`text-sm font-medium rounded-full px-3 py-1 border-0 ${getStatusColor(selectedWorkOrder.status)}`}
                      >
                        <option value="open">Open</option>
                        <option value="scheduled">Scheduled</option>
                        <option value="in_progress">In Progress</option>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          <h4 className="text-sm font-medium text-gray-700 mb-3">Assignment & Schedule</h4>
                          <div className="space-y-2">
                            {selectedWorkOrder.assigned_technician && (
                              <div className="flex items-center text-sm text-gray-600">
                                <User className="w-4 h-4 mr-3" />
                                <div>
                                  <div>Assigned: {selectedWorkOrder.assigned_technician.first_name} {selectedWorkOrder.assigned_technician.last_name}</div>
                                  <div className="text-gray-500 capitalize">{selectedWorkOrder.assigned_technician.role}</div>
                                </div>
                              </div>
                            )}
